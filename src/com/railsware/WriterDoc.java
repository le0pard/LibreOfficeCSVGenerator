...
/*
try {
	String templateFile = "/Users/leo/Downloads/open_doc/1675_template.docx";
	String saveFile = "/Users/leo/Downloads/open_doc/1675_template_res.docx";
	String pdfFile = "/Users/leo/Downloads/open_doc/1675_template_xml.pdf";
	String docTitle = "Temp";
	String csvFile = "/Users/leo/Downloads/open_doc/spd_data.csv";
	
    // get the remote office component context
	String oooExeFolder = "/Applications/LibreOffice.app/Contents/MacOS/soffice";
 ...
 // Create a Search Descriptor 
    ...
    PropertyValue[] properties2 = new PropertyValue[1]; 
    ...
    storable.storeAsURL(saveFileURL, properties2); 
    
    
    String pdfFileURL = filePathToURL(pdfFile);
    System.out.println("pdf " +pdfFileURL); 
    XStorable storable2 = (XStorable) UnoRuntime.queryInterface( 
            XStorable.class, document);
    ...
    storeProps[3].Name = "CompressionMode";
    storeProps[3].Value = "1"; 
    
    storable2.storeToURL(pdfFileURL, storeProps);
